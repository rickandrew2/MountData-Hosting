                            ...
                            <div class="row g-0">
                                <div class="col-12">
                                                ...
                                                <?php foreach ($reviewPhotos as $index => $photo): ?>
                                                    <div class="carousel-item <?= $index === 0 ? 'active' : ''; ?>">
                                                        <div class="img-container">
                                                            <img src="<?= htmlspecialchars($baseReviewImagePath . trim($photo)); ?>" class="d-block w-100 rounded" alt="Mountain Image <?= $index + 1; ?>" style="height: 500px; object-fit: cover;">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                    ...
                                    <?php elseif (count($reviewPhotos) === 1): ?>
                                        <div class="img-container">
                                            <img src="<?= htmlspecialchars($baseReviewImagePath . trim($reviewPhotos[0])); ?>" class="d-block w-100 rounded" alt="Mountain Image" style="height: 500px; object-fit: cover;">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
