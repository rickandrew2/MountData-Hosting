...
<div class="profile-and-feed container-lg" style="min-height: 100vh;">
    <div class="row p-0" id="profileContainer">
      ...
      <div class="col-lg-8 col-md-7 col-sm-12 col-12 mt-5 feed-profile" style="min-height: 60vh;">
        <div class="content feed-container p-3" style="border-bottom: 1px solid #8a8a8a;">
          <h3 class="mt-3" style="text-align: center;">Feed</h3>
        </div>
        <div class="content p-0 mt-5" style="text-align: center;">
          <span class="material-symbols-outlined" style="display: block; margin: 0 auto; font-size: 5rem;">landscape_2_off</span>
          <h3 class="mt-3">Add some photos</h3>
          <p style="color: #8a8a8a;">Log your trail photos by adding on any trail page</p>
        </div>
      </div>
    </div>
